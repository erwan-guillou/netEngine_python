...
from netAbstraction import ClientTCP
from mykeyboard import KBHit

class ServerHandler:
    client: ClientTCP = None

    @staticmethod
    def initialize(cli:ClientTCP):
    ...
    def receiveData(buffer:bytearray):
...
def main():
    ...
    print("==============================================================================")
    print("== tcp-client-test                                NetEngine::NetAbstraction ==")
    print("==============================================================================\n")
